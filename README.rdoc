...
Here is an example of how a mode_filter gets created in your controller:

  class ProfileController < ApplicationController
    def index
      @profiles_filter = Wf::Filter.new("Profile", params, current_user)    
    end
  end  
