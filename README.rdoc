...
Add the “will_paginate” gem created by Mislav Marohnić to your Gemfile.
...
For more details on installing will_paginate, please visit: https://github.com/mislav/will_paginate/wiki/Installation

To install, configure and initialize will_filter engine, run the following commands: 

  $ rails plugin install git://github.com/berk/will_filter.git -r rails3
