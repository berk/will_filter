...
$ rake will_filter:sync  # this copies the necessary migrations, stylesheets, scripts and images to the main project

$ rake db:migrate # this will create the model_filters table so you can save filters you create
...
Note: @own_profile is a user or any identity you want to save filters for
...
will_filter_examples project contains some samples that show you how to customize filters, etc...

If you have any questions, comments or suggestions, email me to theiceberk@gmail.com
